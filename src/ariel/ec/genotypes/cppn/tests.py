...
def display_genome(genome: CPPN_genotype, title: str):
...
def test_crossover():
    ...
    parent_a = CPPN_genotype.random(num_inputs, num_outputs, num_inputs + num_outputs, initial_innov_id)
    ...
    parent_b = CPPN_genotype.random(num_inputs, num_outputs, num_inputs + num_outputs, initial_innov_id)
